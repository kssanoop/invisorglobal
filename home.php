      ...
      <div class="container" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
        ...
        <div class="tab-top">
          <ul class="nav nav-tabs" id="serviceTabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
              <button class="nav-link" id="consulting-tab" data-bs-toggle="tab" data-bs-target="#consulting"
                type="button" role="tab" aria-controls="consulting" aria-selected="false">Zoho Support
              </button>
            </li>
            <li class="nav-item" role="presentation">
              <button class="nav-link" id="hire-tab" data-bs-toggle="tab" data-bs-target="#hire"
                type="button" role="tab" aria-controls="hire" aria-selected="false">Zoho Cunsultant Hire
              </button>
            </li>
            <li class="nav-item ms-auto d-flex align-items-center hvr-underline-from-left">
              <div class="show-more right-arrow">
                ...
                <div class="swiper-slide">
                  <div class="card service-card hvr-underline-from-left">
                    <div class="card-body">
                      ...
                      <div class="card-bdy">
                        <p class="card-text">A customer service platform that helps businesses provide top-tier support through multi-channel ticketing and automation.
                ...
                <div class="swiper-slide">
                  <div class="card service-card hvr-underline-from-left">
                    <div class="card-body">
                      ...
                      <div class="card-bdy">
                        <p class="card-text">A comprehensive HR management solution for streamlining employee records, attendance, and performance reviews.
