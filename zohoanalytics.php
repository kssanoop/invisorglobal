...
<div class="dashboard-container">
    ...
    <img src="assets/img/icons/analytics-dash.png" alt="" class="img-fluid">
</div>
...
<div class="why-choose-section">
    <h2 class="why-choose-title">Why Choose Zoho Analytics?
    </h2>
    ...
    <div class="why-choose-item">
        ...
        <div class="why-choose-content">
            <h3 class="why-choose-feature-title">Make Informed Decisions

            </h3>
            <h6 class="why-choose-description">Zoho Analytics provides powerful, real-time insights, helping you make data-driven decisions that impact growth and efficiency.
    ...
    <div class="why-choose-item">
        ...
        <div class="why-choose-content">
            <h3 class="why-choose-feature-title">Gain a 360° Business View 
            </h3>
            <h6 class="why-choose-description">By consolidating data from all your sources, Zoho Analytics gives you a comprehensive view of business performance, allowing you to spot trends and identify areas for improvement.
            </h6>
        </div>
    </div>
    <!-- Feature 3 -->
    <div class="why-choose-item">
        ...
        <div class="why-choose-content">
            <h3 class="why-choose-feature-title">Drive Collaboration and Alignment
            </h3>
            <h6 class="why-choose-description">With easy sharing and collaboration features, Zoho Analytics helps your team work together effectively, aligning everyone towards shared goals.
            </h6>
        </div>
    </div>
    <!-- Feature 4 -->
    <div class="why-choose-item">
        ...
        <div class="why-choose-content">
            ...
            <h6 class="why-choose-description">With top-notch security protocols, Zoho Analytics ensures that your data remains safe and accessible only to authorised users            .
            </h6>
        </div>
    </div>
</div>
