...
<div class="container-fluid">
    <div class="container zoho-one">
        ...
        <div class="row my-5">
            <div class="col-md-7">
                <h1 class="service-title"><img src="assets/img/icons/zoho-desk.png" alt="" style="width: 40%;"></h1>
                <h1 style="font-weight: 400;">Customer Service That Always Shines 

                </h1>
                <p>In today’s fast-paced world, outstanding customer support is vital. Zoho Desk is a powerful customer service software that centralises all customer interactions, helping your team deliver exceptional service. 
            ...
            <div class="col-md-5" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
                ...
                <img src="assets/img/icons/desk-banner.png" alt="Zoho One Image"
                    class="service-image">
...
<div class="dashboard-container">
    <h2 class="dashboard-title">What is Zoho Desk?
    </h2>
    <p class="dashboard-description">
    Zoho Desk is a powerful help desk software designed to help businesses streamline customer support processes, manage tickets efficiently, and deliver exceptional service. With features for automation, collaboration, and reporting, Zoho Desk empowers teams to enhance customer experiences and build lasting relationships.


    </p>
    <img src="assets/img/icons/what-desk.png" alt="" class="img-fluid">
</div>
...
<!-- ================================================================ -->
    ...
    <section id="features-2" class="features-2 section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <h2 style="text-align: center;margin-bottom: 50px;font-weight: 300;font-size: 3rem;">Key Features of Zoho Desk
        </h2>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-4">
            ...
            <div class="feature-item text-end mb-5" data-aos="fade-right" data-aos-delay="200">
              <div class="d-flex align-items-center justify-content-end gap-4">
                <div class="feature-content">
                  ...
                  <p>Manage customer inquiries seamlessly across multiple channels, including email, chat, social media, and phone. Zoho Desk centralises all customer interactions, providing a unified support experience.
                  </p>
                </div>
              </div>
            ...
            <div class="feature-item text-end mb-5" data-aos="fade-right" data-aos-delay="300">
              <div class="d-flex align-items-center justify-content-end gap-4">
                <div class="feature-content">
                  ...
                  <p>Automate routine tasks like ticket assignment and follow-ups with Zoho Desk’s intelligent workflows, allowing your support team to focus on complex issues and improving efficiency.
            ...
            <div class="feature-item text-end" data-aos="fade-right" data-aos-delay="400">
              <div class="d-flex align-items-center justify-content-end gap-4">
                <div class="feature-content">
                  <h3>Customisable Dashboards and Reports

                  </h3>
                  <p>Visualise key metrics and performance with customisable dashboards and insightful reports. Zoho Desk helps you track ticket resolution times, agent performance, and customer satisfaction in real time.
          ...
          <div class="col-lg-4">
            ...
            <div class="feature-item mb-5" data-aos="fade-left" data-aos-delay="200">
              <div class="d-flex align-items-center gap-4">
                <div class="feature-content">
                  <h3>Knowledge Base Management

                  </h3>
                  <p>Empower customers to find answers quickly with a self-service knowledge base. Zoho Desk enables you to create and manage articles that help customers resolve issues independently.
            ...
            <div class="feature-item mb-5" data-aos="fade-left" data-aos-delay="300">
              <div class="d-flex align-items-center gap-4">
                <div class="feature-content">
                  ...
                  <p>Enhance team collaboration with built-in features for internal communication and ticket sharing. Zoho Desk fosters teamwork, ensuring that complex customer issues are resolved efficiently.
            ...
            <div class="feature-item" data-aos="fade-left" data-aos-delay="400">
              <div class="d-flex align-items-center gap-4">
                <div class="feature-content">
                  <h3>Advanced Security and Compliance

                  </h3>
                  <p>Zoho Desk prioritises data security with robust measures, including encryption, role-based access, and compliance with industry standards, ensuring your customer data is protected.
    ...
    <div class="contact-section">
      <div class="contact-content">
        ...
        <div class="contact-text">
          <h1>Transform Your Business with Zoho Desk
          </h1>
          <p>Zoho Desk empowers businesses to provide outstanding customer support, driving customer satisfaction and loyalty. Whether you’re a small team or a large enterprise, Zoho Desk is the perfect solution for managing customer relationships and enhancing service delivery.
      ...
      <div class="contact-image" data-aos="fade-left" data-aos-anchor-placement="top-bottom">
        <img src="assets/img/icons/desk-center.jpg" alt="People working on laptops">
      </div>
    </div>
...
<div class="why-choose-section">
    <h2 class="why-choose-title">Why Choose Zoho Desk?
    </h2>
    ...
    <div class="why-choose-item">
        ...
        <div class="why-choose-content">
            ...
            <h6 class="why-choose-description">With a streamlined support process and multi-channel capabilities, Zoho Desk enables your team to respond to customer inquiries promptly, improving overall satisfaction.
            </h6>
        </div>
    </div>
    <!-- Feature 2 -->
    <div class="why-choose-item">
        ...
        <div class="why-choose-content">
            ...
            <h6 class="why-choose-description">Customisable reports and dashboards provide valuable insights into support performance, helping you make informed decisions and continuously improve your service.
    ...
    <div class="why-choose-item">
        ...
        <div class="why-choose-content">
            ...
            <h6 class="why-choose-description">Zoho Desk ensures the protection of your customer data with advanced security features, allowing you to focus on providing excellent support without compromising safety.
            </h6>
        </div>
    </div>
</div>
