...
<body class="index-page">
  ...
  <style>
    @media (min-width:992px) {
      ...
      /* Hidden header (slides up) */
      .header-hidden {
        transform: translateY(-100%);
      }

      /* Visible header (slides down) */
      .header-visible {
        transform: translateY(0);
      }

      /* Add space at the top of the content to account for the fixed header */
      .main {
        padding-top: 80px;
    ...
    .callbutton a{display: flex !important;margin: auto !important;      color: #fff !important;
...
justify-content: center !important;
  ...
  <script>
    ...
    window.addEventListener("scroll", () => {
      ...
      if (scrollTop > 100) { // Only trigger after scrolling past 100px
        ...
        // Show header when within the top 100px
        header.classList.add("header-visible");
        header.classList.remove("header-hidden");
      }
  ...
  <style>
    @media (min-width:1200px) {
      ...
      .header .active::after {
        ...
        height: 1px;
        background-color: var(--accent-color);
        /* Match the accent color or choose a new color */
      }
    }
  </style>
  <!-- Popup Form HTML -->
